<script>
  ...
  let selectedCategory = 'lollipops';
...
<div class="pt-16 md:pt-0">
  <div class="flex">
    ...
    <div class="flex-1 min-h-screen bg-gradient-to-br from-cyan-400 via-teal-500 to-green-600 p-8">
  <h1 class="nunito text-2xl md:text-4xl font-bold text-white mb-8 text-center">Lollipops</h1>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
    {#each menuItems.lollipops as item}
