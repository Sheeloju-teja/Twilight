...
<div class="pt-16 md:pt-0">
  <div class="flex">
    <Sidebar  bind:showSidebar bind:selectedCategory variant="mobile" />
    <Sidebar  bind:selectedCategory variant="desktop" />
    <div class="flex-1 min-h-screen bg-gradient-to-br from-purple-400 via-indigo-500 to-blue-600 p-8">
  <h1 class="text-2xl md:text-4xl font-bold text-white mb-8 text-center">Burgers</h1>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
    {#each menuItems.burgers as item}
