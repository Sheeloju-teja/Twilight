...
<div class="pt-16 md:pt-0">
  <div class="flex">
    ...
    <div class="flex-1 min-h-screen bg-gradient-to-br from-yellow-300 via-orange-400 to-red-500 p-8">
  <h1 class="nunito text-2xl md:text-4xl font-bold text-white mb-8 text-center">Sandwiches</h1>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
    {#each menuItems.sandwiches as item}
